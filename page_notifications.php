...
<html>
    ...
    <head>
        <meta charset="utf-8">
        <title>Haaze_notifications</title>
            ...
            <div class="column is-6 middle">
                <div class="box form-publ">
                    ...
                    <div class="box notif-notif pvu">
                        ...
                        <div class="content-notif"><p>Corentin a ajouté une nouvelle publication !</p></div>
                    </div>
                    <div class="box notif-notif pvu">
                        <p class="notif"><img src="img/Profil1.png" alt="img profil" class="profil notif-img"><div class="detail">Corentin 2.8<img class="aze"src="img/logo_1.png"></div></p>
                        <div class="content-notif"><p>Corentin a commenté l'une de vos publications !</p></div>
                    </div>
                    <div class="box notif-notif">
                        ...
                        <div class="content-notif"><p>Thomas a commenté l'une de vos publications !</p></div>
                    </div>
                    <div class="box notif-notif">
                        ...
                        <div class="content-notif"><p>Damien a ajouté une nouvelle publication !</p></div>
                    </div>
                </div>
            </div>
