...
if (empty($_POST["contenus"])){
	...
	// On prepare la bdd
	//$bdd->query('SELECT * from publication');
	/*$req1=$bdd->prepare("INSERT INTO publication (iDpubli,contenus,Nom,Prenom,datePubli,idCompte)VALUES(NULL,:contenus,:nom,:prenom,:datePubli,:idCompte)");
   ...
   // echo $tableau["contenus"]." ".$tableau["datePubli"]." ".$tableau["nom"]." ".$tableau["prenom"];
